...
layui.use(['table', 'form'], function () {
    ...
    table.render({
        ...
        , cols: [[ //表头
            ...
            // , {field: 'parentid', title: '所属部门', width:  "10%"}
            , {field: 'createtime', title: '创建时间', width:  "20%"}
            , {field: 'createname', title: '创建者', width:  "20%"}
            // , {field: 'createuser', title: '创建者', width:  "20%",templet:"#parentMenucode"}
...
//执行重新加载的方法--页面的搜索方法。 search ↑
    ...
    table.on('tool(obj)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
        ...
        if (layEvent === 'detail') {
            ...
            layer.open({
                ...
                shade: .5,
                area: ['600px', '500px'],
                content: objId+'/toEidtDepartment.html'
            })
        }
    });
    //监听工具条↑
    ...
    form.on('submit(formsub)', function (data) {
        ...
        var url = data.field.id==null?"saveOrUpdateAddDepartment.html":"../saveOrUpdateAddDepartment.html";
